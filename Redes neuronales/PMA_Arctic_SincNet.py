##### Script para los datos de PMA-Arctic haciendo uso de una red neuronal basada en SincNet #####
...
# Directorios
path_datos = '..\\SingleWordProductionDutch-main\\PMA\\Arctic'

output_folder_mfcc = '.\\Resultados_mfcc_PMA_Arctic_SincNet\\'
output_folder_audio = '.\\Resultados_audio_PMA_Arctic_SincNet\\'
...
np.save('.\\MCD_PMA_Arctic_SincNet', mcd_mean) # Se guarda el resultado para representarlo gráficamente después
