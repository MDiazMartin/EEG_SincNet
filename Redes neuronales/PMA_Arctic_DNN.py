##### Script para los datos de PMA-Arctic haciendo uso de una DNN #####
...
# Directorios
path_datos_feat = '..\\SingleWordProductionDutch-main\\PMA\\Arctic'
output_folder_mfcc = '.\\Resultados_mfcc_PMA_Arctic_DNN\\'
output_folder_audio = '.\\Resultados_audio_PMA_Arctic_DNN\\'
...
np.save('.\\MCD_PMA_Arctic_DNN', mcd_mean) # Se guarda el resultado para representarlo gráficamente después
